...
def main():
    ...
    fuzzy_data_path = './FMMFSM_tester/use_cases/gear/computed/FMMFSM/gear3.jsonResult.json'
    system_data_path = './FMMFSM_tester/use_cases/gear/computed/System/gear3SysBinary.json'
